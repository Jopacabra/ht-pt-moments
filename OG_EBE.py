        ...
        momentDataframe = pd.DataFrame(
            {
                ...
                "q_BBMG": [energy_loss],
                "q_BBMG_err": [energy_loss_err],
                "q_drift_plasma": [momentPlasma],
                "q_drift_plasma_err": [momentPlasmaErr],
                "q_drift_hrg": [momentHrg],
                "q_drift_hrg_err": [momentHrgErr],
                "q_drift_unhydro": [momentUnhydro],
                "q_drift_unhydro_err": [momentUnhydroErr],
