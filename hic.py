            ...
            trentoDataFrame = pd.DataFrame(
                {
                    ...
                    "phi_2": [float((1/2) * np.arctan2(trentoOutput[5], trentoOutput[4]))],
                    "e3_re": [float(trentoOutput[6])],
                    "e3_im": [float(trentoOutput[7])],
                    "phi_3": [float((1/3) * np.arctan2(trentoOutput[7], trentoOutput[6]))],
                    "e4_re": [float(trentoOutput[8])],
                    "e4_im": [float(trentoOutput[9])],
                    "phi_4": [float((1/4) * np.arctan2(trentoOutput[9], trentoOutput[8]))],
                    "e5_re": [float(trentoOutput[10])],
                    "e5_im": [float(trentoOutput[11])],
                    "phi_5": [float((1/5) * np.arctan2(trentoOutput[11], trentoOutput[10]))],
                    "seed": [randomSeed],
                    "cmd": [trentoCmd],
                }
            )
